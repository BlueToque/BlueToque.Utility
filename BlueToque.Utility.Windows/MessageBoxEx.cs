...
namespace BlueToque.Utility.Windows
{
    ...
    {
        private static IWin32Window? m_owner;
        private static readonly HookProc m_hookProc = MessageBoxHookProc;
        ...
        private static void Initialize(IWin32Window? owner = null)
        {
            ...
            IntPtr ownerHandle = m_owner.Handle;
            uint threadId = NativeMethods.GetWindowThreadProcessId(ownerHandle, out uint _);
            m_hHook = NativeMethods.SetWindowsHookEx(WH_CALLWNDPROCRET, m_hookProc, IntPtr.Zero, threadId);
        }
        ...
        private static void CenterWindow(IntPtr hChildWnd)
        {
            ...
            success = NativeMethods.GetWindowRect(m_owner.Handle, ref recParent);
